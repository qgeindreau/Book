    ...
    searchBtn.addEventListener('click', (e) => {
        ...
        if (searchText.value.length != 0) {
            ...
            fetch("/search/",
                ...
                .then(data => {
                    projetsContainer = document.getElementById('projetsContainer');
                        ...
                        setTimeout(() => {
                            ...
                            <div class="col-12 my-4 text-center">
                                <div class="back-to-projets">
                                    <a href="/projets">Back to projets</a>
                                </div>
                            </div>
                            `;
                        }, 2000);
                    } else {
                        projetsContainer.classList.add('justify-content-center')
                        projetsContainer.innerHTML = `
                            <div class="col-lg-4 text-center s-color">
                                <p>Il n'y a pas de projet contenant '<strong class="color-primary">${data.searchText}</strong>'</p>
                                <div class="back-to-projets">
                                    <a href="/projets">Retourner aux projets</a>
                                </div>
                            </div>
                            `;
                    }
